...
//
//import com.hotel.APIGateway.model.UserDetailsModel;
//
...
//                    .post()
//                    .uri("http://AUTH-SERVICE/auth/validateToken?token=" + authtoken[1])
//                    .retrieve().bodyToMono(UserDetailsModel.class)
//                    .map(userDto ->
//                        {
